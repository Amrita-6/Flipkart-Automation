           ...
           try{
            ...
            wait.until(ExpectedConditions.presenceOfElementLocated(locator));
               ...
               for(WebElement rating : starRatingElements){
                ...
                System.out.println("Count of washing machines with rating less than or equal to " +starRating +":" +washingMachineCount);
                success = true;
               }
         ...
         public static Boolean printTitleAndDiscount(WebDriver driver , By locator , int discount){
            ...
            try{
                ...
                for(Map.Entry<String, String> Titlediscounts : TitlediscountMap.entrySet()){
                     System.out.println("Iphone discount percentage is:" +Titlediscounts.getKey() + "and its title is:" +Titlediscounts.getValue());
         ...
         public static Boolean printTitleAndImageUrl(WebDriver driver , By locator){
             ...
             try{
                ...
                for(int i = 0 ; i<5 ; i++){
                    ...
                    String highestReviewCountAndProductTitle = String.valueOf((i+1)+"highest review count" +formattedUserReviewCount +"Title is" + productTitle);
